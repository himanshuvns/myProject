...
<head>
    ...
    border-radius: 50%;
    box-shadow:0 2px 4px 0 rgba(0,0,0,0.85),0 3px 10px 0 rgba(0,0,0,0.5);
				...
				<div class="first">
					<span class="side">
						<button  class="sidebutton" value="login" >
							<label class="log"><a href="/signup">Signup</a></label>
						</button>
					</span>
					<span  class="sign wow fadeInRight" data-wow-delay="1s" >
					...
					<br>
					<br>
					<form class="form1 wow fadeInRight"  data-wow-delay=".4s">
						<center>
							<img src="a.png" height="120vh"/>
						</center>
						<br>
						<br>
